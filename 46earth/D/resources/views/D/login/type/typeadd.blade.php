...
@section('text')
	...
	<form method="post" action="{{route('typesave')}}" id="sub">
		<fieldset>
			<legend>新增車種</legend><p/>
            車種名稱:<input id="type" type="text" name="type"><p/>
            車廂數量:<input id="car" type="number" name="car"><p/>
            單一車廂量:<input id="singlecar" type="number" name="singlecar"><p/>
